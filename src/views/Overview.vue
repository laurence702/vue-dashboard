    ...
    <div class="body_container">
        ...
        <div class="white_box mt-4">
            <div class="d-flex"> 
                ...
                <router-link to="/transaction" exact>See All <i class="fa fa-angle-right"></i></router-link>
            </div>
            <div class="table_content py-3">
                <table class="table">
                    ...
                    <tbody>
                        <tr class="border-top-0 border-bottom" v-for="transaction in transactions" :key="transaction">
